       ...
       <a href="home.php" class="logo" style="font: bold;">mynger</a>
        <nav>
            <ul>
                ...
                <li class="topnav"><a href="contact.php">Contact us</a></li>
            </ul>
        </nav>
    </div>
</header>
...
<div class="row">
        ...
        <fieldset class="fieldset">
            <legend><h2>Add An Announcement</h2></legend> 
            <textarea type="text" class="textarea" id="tarea" name="tarea" placeholder="Please write your announcement..." required></textarea>
            <input type="submit" class="button" name="submit" value="Add"></input>
        </fieldset>   
        </div>
    ...
    <?php 
            if(isset($_POST['submit'])){
                $announcement = mysqli_real_escape_string($con,$_POST['tarea']);
                $dateTime = date('Y-m-d H:i:s');
                $queryString = "INSERT INTO announcements (announcementContent, dateTime) VALUES ('".$announcement."','".$dateTime."')";
